...
public class UpdateThieuTruongDuLieu {
	...
	@Test
    public void testUpdateMajorWithoutData() {
        ...
        // Xóa dữ liệu trong trường "Tên ngành"
        WebElement nameField = webDriver.findElement(By.id("name"));
        nameField.clear();
        
        // Xóa dữ liệu trong trường "Tên viết tắt"
        ...
        // Kiểm tra xem có hiển thị các thông báo lỗi hay không
        WebDriverWait wait = new WebDriverWait(webDriver, 10);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("name-error")));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("abbreviation-error")));
    }
	@AfterClass
