...
public class UpdateMajor {
	...
	public void testAddUserFunctionality() {
	    ...
	    inputTimKiem.sendKeys("test");
	    
	 // Click vào nút "Chỉnh sửa"
	    webDriver.findElement(By.xpath("//tbody/tr[1]/td[6]/a[1]/i[1]")).click();
        
        // Định vị và xóa văn bản từ trường nhập liệu "Tên ngành"
        WebElement nameField = webDriver.findElement(By.id("name"));
        nameField.clear(); // Xóa văn bản đã có
        nameField.sendKeys("Công Nghệ thông tin"); // Nhập văn bản mới
        

        // Định vị và xóa văn bản từ trường nhập liệu "Viết tắt"
        WebElement abbreviationField = webDriver.findElement(By.id("abbreviation"));
        abbreviationField.clear(); // Xóa văn bản đã có
        abbreviationField.sendKeys("CNTT"); // Nhập văn bản mới
        
        // Chọn loại chương trình
        WebElement programTypeDropdown = webDriver.findElement(By.xpath("//span[@id='select2-program_type-container']"));
        programTypeDropdown.click();
        
        // Chọn loại chương trình từ dropdown
        webDriver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[2]/form[1]/div[4]/div[1]/span[2]/span[1]/span[2]/ul[1]/li[1]")).click();
