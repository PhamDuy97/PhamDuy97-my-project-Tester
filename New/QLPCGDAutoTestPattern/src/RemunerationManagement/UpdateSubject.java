...
public class UpdateSubject {
	...
	public void testAddUserFunctionality() throws InterruptedException {
		...
		// Click vào tab "Môn học"
		WebElement importTab = webDriver.findElement(By.xpath("//*[@id=\"main-menu-navigation\"]/li[6]/ul/li[3]/a"));
		importTab.click();
		...
		webDriver.findElement(By.xpath("//*[@id=\"tblSubject\"]/tbody/tr[1]/td[6]/a")).click();

		// Chờ 1 giây
		Thread.sleep(2000);

		WebElement option = webDriver.findElement(By.id("is_vietnamese"));
		option.click(); 

		// Chờ 1 giây
		Thread.sleep(2000);

		WebElement submitButton = webDriver.findElement(By.xpath("//*[@id=\"subject-form\"]/div[4]/button[2]"));
		submitButton.click();	
