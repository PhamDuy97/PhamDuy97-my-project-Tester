...
public class LectureRankUpdate {
	...
	public void testAddUserFunctionality() throws InterruptedException {
		...
		WebElement smalldropdown = webDriver.findElement(By.xpath("//*[@id=\"lecturerrank-form\"]/div[3]/div/span/span[1]/span/span[2]"));
		smalldropdown.click();
		
		// Chờ 1 giây
		Thread.sleep(2000);
		
		webDriver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[3]/div/span[2]/span/span[2]/ul/li[12]")).click();
		Thread.sleep(1000);
