...
public class UpdateADranks {
	...
	public void testAddUserFunctionality() throws InterruptedException {
		...
		inputTimKiem.sendKeys("999");

		// Click vào nút "Chỉnh sửa"
		webDriver.findElement(By.xpath("//*[@id=\"tblAcademicDegreeRank\"]/tbody/tr[2]/td[2]/a[1]")).click();
		...
		WebElement option = webDriver.findElement(By.xpath("//li[text()='CNTT']"));
		option.click();

		// Chờ 1 giây
		Thread.sleep(2000);

		WebElement submitButton = webDriver.findElement(By.xpath("//*[@id=\"academicdegreerank-form\"]/div[3]/button[2]"));
		submitButton.click();	
	}
