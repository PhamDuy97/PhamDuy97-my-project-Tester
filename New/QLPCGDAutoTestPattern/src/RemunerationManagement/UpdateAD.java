...
public class UpdateAD {
	...
	public void testAddUserFunctionality() throws InterruptedException {
		...
		webDriver.findElement(By.xpath("//*[@id=\"tblAcademicDegree\"]/tbody/tr/td[5]/a[1]")).click();
		...
		nameField.sendKeys("Phần Mềm Thông Tin"); // Nhập văn bản mới
		...
		// Thay đổi thứ tự 
		WebElement levelField = webDriver.findElement(By.id("level"));
		levelField.clear(); // Xóa văn bản đã có
		levelField.sendKeys("25");
