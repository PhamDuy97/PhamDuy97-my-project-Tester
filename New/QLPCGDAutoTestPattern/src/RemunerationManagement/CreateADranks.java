...
public class CreateADranks {
	...
	public void testAddUserFunctionality() throws InterruptedException {
		...
		// Bấm vào chức năng "Thêm Cấp bậc mới "
		webDriver.findElement(By.xpath("//*[@id=\"tblAcademicDegreeRank_wrapper\"]/div[1]/div[2]/div/div[2]/button")).click();

		// Chờ 1 giây
		Thread.sleep(2000);

		WebElement dropdown = webDriver.findElement(By.className("select2-selection__arrow"));
		dropdown.click();

		WebElement option = webDriver.findElement(By.xpath("//li[text()='Phần Mềm Công Nghệ Thông Tin']"));
		option.click();
		...
		// Nhập tên HH,HV
		webDriver.findElement(By.id("id")).sendKeys("999");

		// Chờ 1 giây
		Thread.sleep(2000);

        WebElement saveButton = webDriver.findElement(By.xpath("//*[@id=\"academicdegreerank-form\"]/div[3]/button[2]"));
        saveButton.click();	 	       
